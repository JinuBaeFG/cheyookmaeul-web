...
const CREATE_ADMIN_FAQ_MUTATION = gql`
  mutation createAdminFaq($title: String, $discription: String) {
    createAdminFaq(title: $title, discription: $discription) {
      ok
      error
    }
  }
...
function AddAdminFaq() {
  ...
  const [createAdminFaqMutation] = useMutation<createBannerVariables>(
    CREATE_ADMIN_FAQ_MUTATION,
    {
      onCompleted,
    }
  );
