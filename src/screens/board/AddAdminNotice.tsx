...
const CREATE_ADMIN_NOTICE_MUTATION = gql`
  mutation createAdminNotice($title: String, $discription: String) {
    createAdminNotice(title: $title, discription: $discription) {
      ok
      error
    }
  }
...
function AddAdminNotice() {
  ...
  const [createAdminNoticeMutation] = useMutation<createBannerVariables>(
    CREATE_ADMIN_NOTICE_MUTATION,
    {
      onCompleted,
    }
  );
