...
const CREATE_CONTEST_REPORT_MUTATION = gql`
...
function CreateContestReport() {
  ...
  const [createContestNoticeMutation] = useMutation<any>(
    CREATE_CONTEST_REPORT_MUTATION,
    {
      onCompleted,
    }
  );
...
export default CreateContestReport;
